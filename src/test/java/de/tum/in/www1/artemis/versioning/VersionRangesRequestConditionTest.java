...
public class VersionRangesRequestConditionTest extends AbstractSpringIntegrationBambooBitbucketJiraTest {
    ...
    void testInitEdgeCases() {
        ...
        assertThat(nullCondition.getRanges()).isNull();
    ...
    void testGetMatchingCondition_limits() {
        ...
        dummyRequest.setRequestURI("/api/v1");
        assertThat(condition.getMatchingCondition(dummyRequest)).isNull();
        dummyRequest.setRequestURI("/api/v2");
        assertThat(condition.getMatchingCondition(dummyRequest)).isSameAs(condition);
        dummyRequest.setRequestURI("/api/v3");
        assertThat(condition.getMatchingCondition(dummyRequest)).isSameAs(condition);
        dummyRequest.setRequestURI("/api/v4");
        assertThat(condition.getMatchingCondition(dummyRequest)).isSameAs(condition);
        dummyRequest.setRequestURI("/api/start");
        assertThat(condition.getMatchingCondition(dummyRequest)).isSameAs(condition);
    }
    ...
    void testGetMatchingConditionRanges() {
        ...
        dummyRequest.setRequestURI("/api/v4");
        assertThat(condition.getMatchingCondition(dummyRequest)).isSameAs(condition);
        dummyRequest.setRequestURI("/api/v5");
        assertThat(condition.getMatchingCondition(dummyRequest)).isNull();
        dummyRequest.setRequestURI("/api/start");
        assertThat(condition.getMatchingCondition(dummyRequest)).isNull();
    }
    ...
    void testGetApplicableVersions_empty() {
        ...
        assertThat(condition.getApplicableVersions()).isEmpty();
    }
    ...
    void testCombine_empty() {
        ...
        assertThat(condition1.combine(condition2).getApplicableVersions()).containsExactly(5, 6, 7, 9, 10);
    }
